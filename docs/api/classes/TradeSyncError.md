...
[tradesync-sdk](../globals.md) / TradeSyncError

# Class: TradeSyncError
...
> **new TradeSyncError**(`message`, `code`, `retryable`, `statusCode?`, `originalError?`, `retriesExhausted?`): `TradeSyncError`
...
> `static` **fromResponse**(`statusCode`, `message`, `originalError?`): `TradeSyncError`
